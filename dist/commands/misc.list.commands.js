...
const miscCommands = {
    ...
    registrar: {
        guide: `Ex: *{$p}registrar* - Registra o usuário no Last.fm.\n`,
        msgs: {
            reply: `🎶 *Usuário Registrado!*`,
            error: "Erro ao registrar o usuário no Last.fm."
        },
        function: miscFunctions.registrarCommand
    },
    lt: {
        guide: `Ex: *{$p}lt* - Mostra a música que você está ouvindo no Last.fm.\n`,
        msgs: {
            reply: `🎶 *Música Atual*\n\nArtista: {$1}\nMúsica: {$2}\nScrobbles: {$3}\nAlbum: {$4}`,
            error: "Erro ao obter a música que você está ouvindo."
        },
        function: miscFunctions.ltCommand
    },
    topart: {
        guide: `Ex: *{$p}topart* - Mostra os artistas mais ouvidos no último mês.\n`,
        msgs: {
            reply: `🎶 *Top Artistas*\n\n{$1}`,
            error: "Erro ao obter os artistas mais ouvidos."
        },
        function: miscFunctions.topartCommand
    },
    viadometro: {
